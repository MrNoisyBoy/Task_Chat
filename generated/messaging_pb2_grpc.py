...
class MessagingStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendMessage = channel.unary_unary(
                ...
                request_serializer=messaging__pb2.Message.SerializeToString,
                response_deserializer=messaging__pb2.SendResponse.FromString,
                _registered_method=True)
...
def add_MessagingServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SendMessage': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=messaging__pb2.Message.FromString,
                    response_serializer=messaging__pb2.SendResponse.SerializeToString,
            ),
    }
...
class Messaging(object):
    ...
    def SendMessage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Messaging/SendMessage',
            messaging__pb2.Message.SerializeToString,
            messaging__pb2.SendResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
